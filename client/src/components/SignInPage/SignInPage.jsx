...
import Model3dGreen from "../3dModel/Model3dGreen"
import "../../_reset.scss";
  ...
  return (
    <div className={theme}>
      <div className="background main-box">
        ...
        {open && (
          <Modal theme={theme} open={open} setOpen={setOpen} closeModal={closeModal} />
        )}
        <div className="sign-section-left">
          <div className="model-background-left">{theme === "dark" ? <Model3d/> : <Model3dGreen/>} </div>
          <img
        ...
        <div className="sign-section-right">
          <div className="model-background-right"> {theme === "dark" ? <Model3d/> : <Model3dGreen/>}</div>
        </div>
      </div>
    </div>
  );
